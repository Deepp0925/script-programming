...
$files1 = Get-ChildItem -Path C:\Windows\System32\driverStore -Recurse -Force
Write-Host $files1.count
...
$files2 = Get-ChildItem -Path C:\Windows\System32\driverStore -Filter *.sys -Recurse -Force
Write-Host $files2.count
...
$files3 = Get-ChildItem -Path C:\Windows\System32\driverStore -Filter *.sys -Recurse -Force | Where-Object {$_.Length -gt 512000}
Write-Host $files3.count
...
$files4 = Get-ChildItem -Path C:\Windows\System32\driverStore -Filter *.sys -Recurse -Force | Where-Object {$_.Length -gt 512000 -and $_.Name -like "s*"}
Write-Host $files4.count
